  ...
  const filterSections = [
    {
      ...
      options: ["Research", "Community", "Government", "Corporate", "Non-profit"]
    },
    {
      title: "Status",
      key: "statuses",
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md transform transition-all">
          <div className="flex items-center justify-between p-6 border-b">
            <div>
              <h3 className="text-xl font-semibold text-gray-900">Filter Partners</h3>
              <p className="text-sm text-gray-500 mt-1">Refine your partnership view</p>
            </div>
            <button
              onClick={onClose}
